        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="list_projectdetails.php">Project</a>
                        <a class="collapse-item" href="machine_detailsuser.php">Machines</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="chart_user.php">Graphical View</a>
                        <a class="collapse-item" href="report_usermachinedetails.php">Machine Details</a>
                        <a class="collapse-item" href="report_transprojectwiseuser.php">Projectwise Transections</a>
                        <a class="collapse-item" href="report_transmachineidwiseuser.php">Machine wise Transections</a>
                        <a class="collapse-item" href="report_maintenanceloguser.php">Maintenance Logs</a>
                        <a class="collapse-item" href="report_alllogsuser.php">All Machine Logs</a>
                        <a class="collapse-item" href="report_detailsclient.php">Detail report</a>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand topbar mb-4 static-top shadow">
                    ...
                    <button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3">
                     ...
                     <!-- Centered Admin Text -->
                    <h3 class="position-absolute w-100 text-center m-0" style="pointer-events: none;">User -  <?php echo $_SESSION['client_name']; ?></h3>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in p-0" aria-labelledby="userDropdown" style="min-width: 260px; border-radius: 12px; overflow: hidden; border: 1px solid rgba(0,0,0,0.1);">
                                ...
                                <div class="dropdown-header text-center text-white py-4" style="background: linear-gradient(135deg, var(--primary), var(--primary-dark));">
                                    ...
                                    <h6 class="m-0 font-weight-bold" style="font-size: 1.1rem; letter-spacing: 0.5px;"><?= htmlspecialchars($_SESSION['name'] ?? 'Client') ?></h6>
                                    <span class="badge badge-light mt-1 text-primary" style="font-size: 0.75rem; padding: 4px 8px; border-radius: 20px;"><?= htmlspecialchars($_SESSION['role'] ?? 'Client') ?></span>
                                </div>
                                ...
                                <div class="px-3 py-3 dropdown-body-custom">
                                    ...
                                    <div class="d-flex align-items-center mt-2 p-2 rounded" style="background-color: rgba(46, 204, 113, 0.05);">
                                        ...
                                        <div>
                                            <span class="d-block font-weight-bold" style="font-size: 0.9rem; color: var(--text-main);"><?= htmlspecialchars($_SESSION['role'] ?? 'Client') ?> Access</span>
