...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <select name="project_name" id="project_name" class="form-control" onchange="submitForm()" required>
            ...
            <?php
            $q = mysqli_query($conn, "SELECT DISTINCT project_name FROM machines WHERE client_name = '$client_name'");
...
if(!empty($selectedProject) && !empty($selectedYear)){
    ...
    WHERE m.project_name='$selectedProject' AND m.client_name = '$client_name'  
