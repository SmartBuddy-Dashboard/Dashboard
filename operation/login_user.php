...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // ✅ Update the column name for password to match your clients table
    $query = "SELECT * FROM clients 
              WHERE client_phone = '$mobile' 
    ...
    if ($result && mysqli_num_rows($result) == 1) {
        ...
        // ✅ Store both client name and mobile in session
        $_SESSION['mobile'] = $row['client_phone'];
