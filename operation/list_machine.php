...
<thead style=' border:1px solid #ddd;'>
    <tr>
        <th style='border:1px solid #ddd; width:6%;'>Sr. No</th>

        <th style='border:1px solid #ddd; width:35%;'>Client Name</th>

        <th style='border:1px solid #ddd; width:10%;'>SO Number</th>

        <th style='border:1px solid #ddd; width:15%;'>Machine ID</th>

        <th style='border:1px solid #ddd; width:10%;'>City</th>

        <th style='border:1px solid #ddd; width:7%;'>Entry Fee</th>

        <th style='border:1px solid #ddd; width:10%;'>Mode</th>

        <th style='border:1px solid #ddd; width:6%; white-space:nowrap;'>Action</th>
    </tr>
</thead>
<tbody>";
