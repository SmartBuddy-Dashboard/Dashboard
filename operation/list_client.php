...
const fileName = `Client Details Report-${timestamp}`;
...
"<'row mt-2'<'col-md-5'i><'col-md-7'p>>",
    ...
    customize: function (doc) {
        ...
        let titleText = `Client Details Report-${timestamp}`;
            ...
            <div style="margin-bottom:15px; border-bottom: 2px solid #000; padding-bottom: 10px;">
                <div style="display:flex; justify-content:space-between; align-items:center;">
                    ...
                    <div style="text-align:center; width:40%;">
                        ...
                        <div style="font-size:14px; font-weight:bold;">Client Details Report-${timestamp}</div>
                    </div>
