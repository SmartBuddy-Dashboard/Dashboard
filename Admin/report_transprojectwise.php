...
<div class="card shadow">
    <div class="card-header text-center">
        <h5><b>Report Transaction Details (Project Wise)</b></h5>
    </div>
...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <select name="project_name" id="project_name" class="form-control" onchange="submitForm()" required>
            <option value="">-- Select Project --</option>
            <?php
            $q = mysqli_query($conn, "SELECT DISTINCT project_name FROM projects");
            while($r = mysqli_fetch_assoc($q)){
                $p = $r['project_name'];
                echo "<option value='$p' ".($p==$selectedProject?'selected':'').">$p</option>";
            }
            ?>
        </select>
    </div>
...
if(!empty($selectedProject) && !empty($selectedYear)){
    ...
    WHERE m.project_name='$selectedProject' 
...
const fileName = `Transaction Report(Projectwise)-${timestamp}`;
    ...
    customize: function (doc) {
        ...
        let titleText = `Transaction Report(Projectwise)-${timestamp}`;
            ...
            <div style="margin-bottom:15px; border-bottom: 2px solid #000; padding-bottom: 10px;">
                <div style="display:flex; justify-content:space-between; align-items:center;">
                    ...
                    <div style="text-align:center; width:40%;">
                        ...
                        <div style="font-size:14px; font-weight:bold;">Transaction Report(Projectwise)-${timestamp}</div>
                    </div>
