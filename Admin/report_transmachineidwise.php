...
<div class="card shadow">
    <div class="card-header text-center">
        ...
        <input type="hidden" name="machine_id" value="<?= $selectedProject; ?>">
...
<?php
if (!empty($selectedProject) && !empty($from_date) && !empty($to_date)) {
    ...
    WHERE m.machine_id='$selectedProject' 
...
const fileName = `Transaction Report(Machinewise)-${timestamp}`;
    ...
    getBase64FromImageUrl(logoPath, function (logoBase64) {
        ...
        $('#userTable').DataTable({
         ...
         dom:
    "<'row'<'col-md-6'B><'col-md-6 text-right'<'backBtn'>>>" +
    ...
    $('.backBtn').html(`
    <button onclick="window.location.href='report_details.php'"
