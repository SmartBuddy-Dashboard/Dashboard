...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Query to check user in tblusers table
    ...
    if ($result && mysqli_num_rows($result) == 1) {
        ...
        $updateQuery = "UPDATE tblusers SET is_logged_in = 1 WHERE mobile = '$mobile'";
        ...
        echo "<script>
                document.addEventListener('DOMContentLoaded', function() {
                    showAlert('❌ Invalid credentials or inactive account', 'danger');
                });
              </script>";
    }
}
