...
#userTable tbody tr:nth-child(odd) { background:#fbdede !important; }
...
<div class="card shadow">
    <div class="card-header text-center">
        <h5><b><i class="fas fa-file-invoice-dollar" style="color:#00b894; margin-right:8px;"></i>Report Machine Maintenance Log Details</h5></b></h5>
    </div>
...
<form method="POST" id="complaintForm">
    ...
    <div class="form-row">
        <div class="form-group col-md-3">
            <label for="machine_id"><strong>Machine ID:</strong></label>
            <select class="form-control" name="machine_id" id="machine_id" required onchange="submitForm()">
                <option value="">-- Select Machine ID --</option>
                <?php
                $stateQuery = "SELECT DISTINCT machine_id FROM machines";
...
const fileName = `Maintenance Report-${timestamp}`;
    ...
    customize: function (doc) {
        ...
        let titleText = `Maintenance Report-${timestamp}`;
            ...
            <div style="margin-bottom:15px; border-bottom: 2px solid #000; padding-bottom: 10px;">
                <div style="display:flex; justify-content:space-between; align-items:center;">
                    ...
                    <div style="text-align:center; width:40%;">
                        ...
                        <div style="font-size:14px; font-weight:bold;">Maintenance Report-${timestamp}</div>
                    </div>
