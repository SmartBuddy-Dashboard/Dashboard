...
/* ============================================
   ONE LINE FIXED KPI CARDS (NO SCROLL)
   ============================================ */
.kpi-grid {
...
<div class="row">
    ...
    <div class="col-md-3">
        ...
        <select name="client_name" id="client_name" class="form-control" onchange="submitForm()">
            <option value="">All Client</option>
            <?php
            $q = mysqli_query($conn,"SELECT DISTINCT client_name FROM clients ORDER BY client_name");
            while($row = mysqli_fetch_assoc($q)){
                $name = $row['client_name'];
                $sel  = ($name == $selectedClient) ? "selected" : "";
...
?>
    <div class="kpi-grid">
    <!-- CARD 1: Transactions - Light Blue -->
    <div class="kpi-card" style="background: linear-gradient(135deg, #e3f2fd 0%, #d0e8ff 100%);">
        <div class="kpi-icon-bg" style="background: linear-gradient(145deg, #bbdef5, #90caf9);">
            <i class="fas fa-exchange-alt" style="color: #1565c0;"></i>
        </div>
        <div class="kpi-content">
            <div class="kpi-label" style="color: #1565c0;">TRANSACTIONS</div>
            <div class="kpi-value" style="color: #0d3c6e;"><?= number_format($total_trans) ?></div>
        </div>
    </div>

    <!-- CARD 2: Total Uses - Light Green -->
    <div class="kpi-card" style="background: linear-gradient(135deg, #e8f5e9 0%, #d4f0d4 100%);">
        <div class="kpi-icon-bg" style="background: linear-gradient(145deg, #c8e6c9, #a5d6a7);">
            <i class="fas fa-restroom" style="color: #2e7d32;"></i>
        </div>
        <div class="kpi-content">
            <div class="kpi-label" style="color: #2e7d32;">TOTAL USES</div>
            <div class="kpi-value" style="color: #1b5e20;"><?= number_format($total_uses) ?></div>
        </div>
    </div>

    <!-- CARD 3: Revenue - Light Orange -->
    <div class="kpi-card" style="background: linear-gradient(135deg, #fff3e0 0%, #ffecbc 100%);">
        <div class="kpi-icon-bg" style="background: linear-gradient(145deg, #ffe0b2, #ffcc80);">
            <i class="fas fa-rupee-sign" style="color: #e65100;"></i>
        </div>
        <div class="kpi-content">
            <div class="kpi-label" style="color: #e65100;">REVENUE</div>
            <div class="kpi-value" style="color: #bf360c;">₹<?= number_format($total_revenue,2) ?></div>
        </div>
    </div>

    <!-- CARD 4: Free Uses - Light Pink -->
    <div class="kpi-card" style="background: linear-gradient(135deg, #fce4ec 0%, #ffdee5 100%);">
        <div class="kpi-icon-bg" style="background: linear-gradient(145deg, #f8bbd0, #f48fb1);">
            <i class="fas fa-gift" style="color: #c2185b;"></i>
        </div>
        <div class="kpi-content">
            <div class="kpi-label" style="color: #c2185b;">FREE USES</div>
            <div class="kpi-value" style="color: #880e4f;"><?= number_format($total_free) ?></div>
        </div>
    </div>

    <!-- CARD 5: Clients - Light Teal -->
    <div class="kpi-card" style="background: linear-gradient(135deg, #e0f2f1 0%, #ccebe8 100%);">
        <div class="kpi-icon-bg" style="background: linear-gradient(145deg, #b2dfdb, #80cbc4);">
            <i class="fas fa-building" style="color: #00695c;"></i>
        </div>
        <div class="kpi-content">
            <div class="kpi-label" style="color: #00695c;">CLIENTS</div>
            <div class="kpi-value" style="color: #004d40;"><?= $total_clients ?></div>
        </div>
    </div>

    <!-- CARD 6: Projects - Light Purple -->
    <div class="kpi-card" style="background: linear-gradient(135deg, #f3e5f5 0%, #ede2f5 100%);">
        <div class="kpi-icon-bg" style="background: linear-gradient(145deg, #e1bee7, #ce93d8);">
            <i class="fas fa-diagram-project" style="color: #6a1b9a;"></i>
        </div>
        <div class="kpi-content">
            <div class="kpi-label" style="color: #6a1b9a;">PROJECTS</div>
            <div class="kpi-value" style="color: #4a148c;"><?= $total_projects ?></div>
        </div>
    </div>

    <!-- CARD 7: Machines - Light Indigo -->
    <div class="kpi-card" style="background: linear-gradient(135deg, #e8eaf6 0%, #e0e3f5 100%);">
        <div class="kpi-icon-bg" style="background: linear-gradient(145deg, #c5cae9, #9fa8da);">
            <i class="fas fa-microchip" style="color: #283593;"></i>
        </div>
        <div class="kpi-content">
            <div class="kpi-label" style="color: #283593;">MACHINES</div>
            <div class="kpi-value" style="color: #1a237e;"><?= $total_machines ?></div>
        </div>
    </div>
</div>
...
<!-- Graph Button -->
<form action='chart.php' method='POST' style='margin:0;'>
...
<form action='report_transmachineidwise.php' method='POST' style='margin:0;'>
