...
<div class="card shadow">
    <div class="card-header text-center">
        <h5><b> <i class="fas fa-file-invoice-dollar" style="color:#00b894; margin-right:8px;"></i>
    Report All Machine Logs Details</h5></b></h5>
    </div>
...
const fileName = `All Logs Report-${timestamp}`;
    ...
    customize: function (doc) {
        ...
        let titleText = `All Logs Report-${timestamp}`;
            ...
            <div style="margin-bottom:15px; border-bottom: 2px solid #000; padding-bottom: 10px;">
                <div style="display:flex; justify-content:space-between; align-items:center;">
                    ...
                    <div style="text-align:center; width:40%;">
                        ...
                        <div style="font-size:14px; font-weight:bold;">All Logs Report-${timestamp}</div>
                    </div>
