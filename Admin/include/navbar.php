        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item"><a class="nav-link" href="list_user.php"><i class="fas fa-fw fa-folder"></i><span>Users</span></a>
			</li>
         ...
         <?php }?>
            ...
            <li class="nav-item">
                ...
                <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="list_user.php">Users</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="report_details.php">Details Report</a>
                        
                        <!--<a class="collapse-item" href="chart.php">Graphical View</a>
                        <a class="collapse-item" href="report_machinedetails.php">Machine Details</a>
                        <a class="collapse-item" href="report_transclientidwise.php">Clientwise Transactions</a>
                        <a class="collapse-item" href="report_transprojectwise.php">Projectwise Transactions</a>
                        <a class="collapse-item" href="report_transmachineidwise.php">Machine wise Transactions</a>
                        -->
            ...
            <li class="nav-item">
                <a class="nav-link" href="#" data-toggle="modal" data-target="#logoutModal">
                    <i class="fas fa-fw fa-sign-out-alt" style="color: var(--danger);"></i>
                    <span style="color: var(--danger); font-weight: bold;">Logout</span>
                </a>
            </li>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header flex-column text-center">
                <h4 class="w-100">Admin</h4>
                <h5 class="modal-title w-100" id="exampleModalLabel">Ready to Leave?</h5>
                
                <button class="close position-absolute" style="right:15px;" type="button" data-dismiss="modal" aria-label="Close">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand topbar mb-4 static-top shadow">
                    ...
                    <button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3">
                     ...
                     <!-- Centered Admin Text -->
                    <h3 class="position-absolute w-100 text-center m-0" style="pointer-events: none;">ADMIN</h3>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item d-flex align-items-center">
                            <button type="button" id="my-new-theme-btn" class="theme-toggle-btn" title="Toggle Theme" onclick="toggleThemeNow()">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in p-0" aria-labelledby="userDropdown" style="min-width: 260px; border-radius: 12px; overflow: hidden; border: 1px solid rgba(0,0,0,0.1);">
                                ...
                                <div class="dropdown-header text-center text-white py-4" style="background: linear-gradient(135deg, var(--primary), var(--primary-dark));">
                                    ...
                                    <span class="badge badge-light mt-1 text-primary" style="font-size: 0.75rem; padding: 4px 8px; border-radius: 20px;"><?= htmlspecialchars($_SESSION['role'] ?? 'Admin') ?></span>
                                </div>
                                ...
                                <div class="px-3 py-3 dropdown-body-custom">
                                    ...
                                    <div class="d-flex align-items-center mt-2 p-2 rounded" style="background-color: rgba(46, 204, 113, 0.05);">
                                        ...
                                        <div>
                                            <span class="d-block font-weight-bold" style="font-size: 0.9rem; color: var(--text-main);"><?= htmlspecialchars($_SESSION['role'] ?? 'Admin') ?> Access</span>
